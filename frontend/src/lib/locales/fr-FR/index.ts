...
export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Cortex NoteBookLM est injoignable",
    ...
    docLink: "Documentation de Cortex NoteBookLM",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Cortex NoteBookLM à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Cortex NoteBookLM est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Cortex NoteBookLM",
    missingRequiredModels: "Modèles requis manquants : {{models}}. Cortex NoteBookLM pourrait ne pas fonctionner correctement sans eux.",
