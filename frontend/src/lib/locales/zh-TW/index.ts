...
export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 Cortex NoteBookLM API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Cortex NoteBookLM 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 Cortex NoteBookLM 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{{models}}。如果没有這些模型，Cortex NoteBookLM 可能無法正常運行。",
