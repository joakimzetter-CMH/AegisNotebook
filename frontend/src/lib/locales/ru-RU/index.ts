...
export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Cortex NoteBookLM недоступен",
    ...
    docLink: "Документация Cortex NoteBookLM",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Cortex NoteBookLM автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Cortex NoteBookLM.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Cortex NoteBookLM",
    missingRequiredModels: "Отсутствуют необходимые модели: {{models}}. Cortex NoteBookLM может работать некорректно без них.",
