...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + AegisNotebook
...
### Step 4: Configure AegisNotebook
...
```yaml
# In your AegisNotebook docker-compose.yml
environment:
...
### Step 5: Add Model in AegisNotebook
...
### AegisNotebook in Docker (macOS/Windows)

**STT Base URL:** `http://host.docker.internal:8969/v1`

### AegisNotebook in Docker (Linux)
...
# From inside AegisNotebook container
