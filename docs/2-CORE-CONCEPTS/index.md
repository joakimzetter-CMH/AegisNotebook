# Core Concepts - Understand the AegisNotebook Mental Model

Before diving into how to use AegisNotebook, it's important to understand **how it thinks**. These core concepts explain the "why" behind the design.

## The Six Mental Models

### 1. [Notebooks, Sources, and Notes](notebooks-sources-notes.md)
How AegisNotebook organizes your research. Understand the three-tier container structure and how information flows from raw materials to finished insights.
...
How AegisNotebook makes AI aware of your research - two different approaches.
...
Why AegisNotebook has different interaction modes and when to use each one.
...
Why AegisNotebook can turn research into audio and why this matters.
...
### 6. [Research Sessions](research-sessions.md)

How AegisNotebook connects several notebooks into one research conversation and
turns that conversation into versioned documents.

**Key idea**: Ask mode explores scoped material; Generate mode creates or
refines a durable deliverable.

---

## Read This Section If:

- **You're new to AegisNotebook** — Start here to understand how the system works conceptually before learning the features
...
- **You need to combine notebooks** — Section 6 explains research sessions and generated documents

---

## The Big Picture

AegisNotebook is built on a simple insight: **Your research deserves to stay yours**.
...
2. **Want to understand it first?** → Read the 6 sections above (15 min)
