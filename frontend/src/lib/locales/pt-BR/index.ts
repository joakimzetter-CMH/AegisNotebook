...
export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Cortex NoteBookLM não pôde ser alcançado",
    ...
    docLink: "Documentação do Cortex NoteBookLM",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Cortex NoteBookLM exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Cortex NoteBookLM está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Cortex NoteBookLM",
    missingRequiredModels: "Modelos obrigatórios ausentes: {{models}}. O Cortex NoteBookLM pode não funcionar corretamente sem eles.",
