...
Configuration is how you customize AegisNotebook for your specific setup. This section covers what you need to know.
...
You will only use .env if you are running AegisNotebook locally.
...
```
1. Open AegisNotebook in your browser
