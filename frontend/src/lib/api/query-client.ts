...
export const QUERY_KEYS = {
  ...
  researchSession: (sessionId: string) => ['research-sessions', sessionId] as const,
  researchSessionDocuments: (sessionId: string) => ['research-sessions', sessionId, 'documents'] as const,
  generatedDocument: (documentId: string) => ['generated-documents', documentId] as const,
