export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Cortex NoteBookLM API server could not be reached",
    ...
    docLink: "Cortex NoteBookLM Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Cortex NoteBookLM to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Cortex NoteBookLM is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Cortex NoteBookLM",
    missingRequiredModels: "Missing required models: {{models}}. Cortex NoteBookLM may not function properly without these.",
