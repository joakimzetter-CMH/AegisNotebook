...
export const zhCN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "无法访问 Cortex NoteBookLM API 服务器",
    dbTitle: "数据库连接失败",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 Cortex NoteBookLM 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{{models}}。如果没有这些模型，Cortex NoteBookLM 可能无法正常运行。",
