...
# Separate checkpoint file for research sessions (open_notebook/graphs/session.py).
# Kept apart from LANGGRAPH_CHECKPOINT_FILE to avoid mixing chat.py's
# ThreadState shape with session.py's SessionState shape in the same store.
SESSION_CHECKPOINT_FILE = f"{sqlite_folder}/session_checkpoints.sqlite"
