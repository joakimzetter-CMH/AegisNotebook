...
export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Cortex NoteBookLM non è raggiungibile",
    ...
    docLink: "Documentazione Cortex NoteBookLM",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Cortex NoteBookLM di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Cortex NoteBookLM.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Cortex NoteBookLM",
    missingRequiredModels: "Modelli richiesti mancanti: {{models}}. Cortex NoteBookLM potrebbe non funzionare correttamente senza questi.",
