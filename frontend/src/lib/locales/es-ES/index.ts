...
export const esES = {
  ...
  connectionErrors: {
    ...
    apiDesc: "No se pudo alcanzar el servidor API de Cortex NoteBookLM",
    ...
    docLink: "Documentación de Cortex NoteBookLM",
  ...
  settings: {
    ...
    filesHelp: "Una vez que tus archivos se suben y procesan, ya no son necesarios. La mayoría de los usuarios deberían permitir que Cortex NoteBookLM elimine los archivos subidos de la carpeta de carga automáticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Una nueva versión de Cortex NoteBookLM está disponible.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura qué modelos usar para diferentes propósitos en Cortex NoteBookLM",
    missingRequiredModels: "Faltan modelos requeridos: {{models}}. Cortex NoteBookLM puede no funcionar correctamente sin estos.",
