...
export const jaJP = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Cortex NoteBookLM APIサーバーに到達できませんでした",
    ...
    docLink: "Cortex NoteBookLMドキュメント",
  ...
  settings: {
    ...
    filesHelp: "ファイルがアップロードされて処理されると、ファイル自体は不要になります。ほとんどのユーザーはCortex NoteBookLMがアップロードフォルダから自動的にファイルを削除することを許可すべきです。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Cortex NoteBookLMの新しいバージョンが利用可能です。",
    upToDate: "最新版です",
    unknown: "不明",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Cortex NoteBookLM全体で異なる目的に使用するモデルを設定",
    missingRequiredModels: "必須モデルがありません: {{models}}。これらがないとCortex NoteBookLMが正しく機能しない可能性があります。",
